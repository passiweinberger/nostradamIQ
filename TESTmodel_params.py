...
MODEL_PARAMS = {
    ...
    'modelParams': {
        ...
        'sensorParams': {
            ...
            # Devide Data into timebins of a day // change for other timebins! -> Have the UI change this! TODO
            'aggregationInfo' : {
                                'days': 0,
                                'fields': [('timestamp', 'event', 'scalar')],
                                'hours': 0,
                                'microseconds': 0,
                                'milliseconds': 0,
                                'minutes': 0,
        ...
        'anomalyParams': {  u'anomalyCacheRecords': None,
            u'autoDetectThreshold': 0.9, #None,
            u'autoDetectWaitRecords': 600},
